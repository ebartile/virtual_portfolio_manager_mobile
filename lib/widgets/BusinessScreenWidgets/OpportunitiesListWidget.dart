import 'package:vpm/screens/CollabRequestsScreen.dart';
...
class OpportunitiesListWidget extends StatefulWidget {
  ...
  OpportunitiesListWidget(this.selectedBusiness);
...
class _OpportunitiesListWidgetState extends State<OpportunitiesListWidget> {
  ...
  Future setToken() async {
    SharedPreferences.getInstance().then((prefValue) {
      ...
      collabJobsList = getAllCollabJobs(token, widget.selectedBusiness['businessId']);
      setState(() {});
    });
  }
...
Future<dynamic> getAllCollabJobs(String token, String businessID) async {
  var headers = {
    'x-api-key':
  ...
  var request = http.Request('GET',
      Uri.parse('http://192.168.203.76:8080/api/getAllCollabJobForABusiness/' + businessID));
...
Future<dynamic> sendCollabRequest(String token, String collabId) async {
  ...
  var request = http.Request(
      'POST', Uri.parse('http://192.168.203.76:8080/api/sendRequestToCollab'));
