...
class BusinessCollaboratorsWidget extends StatefulWidget {
  final Map selectedBusiness;

  BusinessCollaboratorsWidget(this.selectedBusiness);
  @override
  _BusinessCollaboratorsWidgetState createState() =>
      _BusinessCollaboratorsWidgetState();
}

class _BusinessCollaboratorsWidgetState extends State<BusinessCollaboratorsWidget> {
  String token;
  String username;
  ...
  Future setToken() async {
    SharedPreferences.getInstance().then((prefValue) {
      ...
      collabJobsList = getAllAcceptedCollabJobs(
          token, widget.selectedBusiness['selectedBusiness']['businessAddress']);
      setState(() {});
    });
  }
...
Future<dynamic> getAllAcceptedCollabJobs(
    String token, String businessAddress) async {
  var headers = {
    'x-api-key':
  ...
  var request = http.Request(
      'GET',
      Uri.parse(
          'http://192.168.203.76:8080/api/getCollabAcceptedRequest/' + businessAddress));
