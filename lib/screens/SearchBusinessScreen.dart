...
class SearchBusinessScreen extends StatefulWidget {
  @override
  _SearchBusinessScreenState createState() => _SearchBusinessScreenState();
}
...
class _SearchBusinessScreenState extends State<SearchBusinessScreen> {
  ...
  searchForBusinessMethod(businessName) {
    ...
    businessList = searchBusiness(token, businessName);
  }
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          _formKey.currentState.validate()
                              ? searchForBusinessMethod(searchBarController.text)
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            'Search for a business by entering its name in the search bar above',
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              color: Colors.grey,
                            ),
...
Future<dynamic> searchBusiness(String token, String businessName) async {
  var headers = {
    'x-api-key':
  ...
  var request =
      http.Request('POST', Uri.parse('http://192.168.203.76:8080/api/searchBusiness'));
  request.body = json.encode({"business_name": businessName});
