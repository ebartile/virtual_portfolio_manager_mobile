...
class CollabRequestsScreen extends StatefulWidget {
  ...
  CollabRequestsScreen(
      {this.collabId, this.businessAddress, this.collabTitle, this.collabAmount});
...
class _CollabRequestsScreenState extends State<CollabRequestsScreen> {
  ...
  acceptCollabRequestMethod(
      {collabId, colUsername, colAddress, colTitle, colAmount, businessAddress}) {
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      backgroundColor: Colors.white,
      duration: Duration(days: 1),
      padding: EdgeInsets.only(
...
Future<dynamic> getAllCollabRequests(String token, String collabId) async {
  ...
  var request = http.Request(
      'GET',
      Uri.parse(
          'http://192.168.203.76:8080/api/getAllCollabRequestForABusinessJob/' + collabId));
...
Future<dynamic> rejectCollabRequest(
  ...
  var request = http.Request('PUT',
      Uri.parse('http://192.168.203.76:8080/api/rejectCollabRequestForABusinessJob'));
  request.body =
...
Future<dynamic> acceptCollabRequest({
  ...
  var request = http.Request(
      'POST', Uri.parse('http://192.168.203.76:8080/api/acceptUsersRequest'));
