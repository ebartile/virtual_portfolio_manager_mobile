          ...
          children: [
            ...
            Container(
              ...
              child: FutureBuilder<dynamic>(
                  future: getBusinessesInvestedByUser(token),
                  builder:
...
Future<dynamic> getBusinessesInvestedByUser(String token) async {
  var headers = {
    'x-api-key':
  ...
  var request = http.Request(
      'GET', Uri.parse('http://192.168.203.76:8080/api/getBusinessesInvestedByUser'));
