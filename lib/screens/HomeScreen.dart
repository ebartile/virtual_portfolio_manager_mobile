...
import 'package:vpm/screens/SearchBusinessScreen.dart';
...
import 'package:vpm/widgets/HomeScreenWidget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          child: ListView(
            children: <Widget>[
              ...
              ListTile(
                ...
                title: Text('Businesses owned'),
                onTap: () {
                  Navigator.of(context).pushNamed(UsersBusinessScreen.routeName);
                },
              ),
              Divider(),
              ListTile(
      ...
      body: PageView(
        ...
        children: [
          KeepAlivePage(child: SearchBusinessScreen()),
          KeepAlivePage(child: HomeScreenWidget()),
          CreateBusinessHomeScreen(),
        ],
      ),
