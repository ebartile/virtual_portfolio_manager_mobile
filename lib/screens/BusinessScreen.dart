import 'package:vpm/widgets/BusinessScreenWidgets/BusinessesAngelListWidget.dart';
import 'package:vpm/widgets/BusinessScreenWidgets/CollabWidget.dart';
import 'package:vpm/widgets/BusinessScreenWidgets/MoreBusinessDataWidget.dart';
import 'package:vpm/widgets/appBarGoBack.dart';
import 'package:vpm/widgets/BusinessScreenWidgets/InvestWidget.dart';
                      ...
                      Positioned(
                        ...
                        child: ProgressiveImage(
                          ...
                          thumbnail:
                              AssetImage('assets/images/placeholder.jpg'),
                          image: NetworkImage(
                            snapshot.data['details']['business_image'],
                          ),
                          fit: BoxFit.cover,
                          height: 250,
                          width: MediaQuery.of(context).size.width,
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: TabBarView(
                                  ...
                                  children: [
                                    InvestWidget(
                                        snapshot, username, selectedBusiness),
                                    CollabWidget(
                                        snapshot,
                                        username,
                                        selectedBusiness,
                                    ...
                                    KeepAlivePage(
                                        child: BusinessesAngelListWidget(
                                      selectedBusiness,
                                      snapshot.data['details']['target'],
                                      snapshot.data['details']['equity'],
                                    )),
                                    MoreBusinessDataWidget(snapshot),
                                  ],
                                ),
                              ),
                            ],
...
Future<dynamic> getBusinesses(String token, String businessAddress) async {
  var headers = {
    'x-api-key':
  ...
  var request = http.Request(
      'POST', Uri.parse('http://192.168.203.76:8080/api/getBusinessMasterDetails'));
