...
class CreateBusinessCollabJobScreen extends StatefulWidget {
  static String routeName = '/createBusinessCollabJob';

  @override
  _CreateBusinessCollabJobScreenState createState() =>
      _CreateBusinessCollabJobScreenState();
}

class _CreateBusinessCollabJobScreenState extends State<CreateBusinessCollabJobScreen> {
  Map businessData = {};
  String token;
  ...
  void createBusinessCollabJob() {
    ...
    newCollabJobForBusiness(token, businessData['businessId'], businessData['businessOwner'],
      ...
      if (data['result'] == true) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            content: Text(
              "New collab job added to the business",
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            padding: EdgeInsets.all(20),
            content: Text(
              "There was a problem adding a collab job to the business",
              textAlign: TextAlign.center,
              style: TextStyle(fontSize: 16),
            ),
          ),
  ...
  Widget build(BuildContext context) {
    businessData = ModalRoute.of(context).settings.arguments;
    print(businessData);
    return Scaffold(
                    ...
                    child: ListView(
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            decoration: InputDecoration(
                              labelText: 'Collab job VPM amount',
                              labelStyle: TextStyle(fontSize: 15),
                              filled: true,
                              fillColor: Colors.grey[50],
                              focusedBorder: OutlineInputBorder(
                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(top: 0),
                          child: Text(
                            'Create new collab job for the business',
                            style: TextStyle(
                              fontSize: 16,
                              color: Colors.white,
                              fontWeight: FontWeight.bold,
...
Future<dynamic> newCollabJobForBusiness(
    String token,
    String businessID,
  ...
  var request = http.Request(
      'POST', Uri.parse('http://192.168.203.76:8080/api/newCollabJobForBusiness'));
  request.body = json.encode({
    "business_id": businessID,
    "business_owner_username": businessOwner,
